...
public class ProgrammerController {
    ...
    public ProgrammerController(@Qualifier("programmerRepositoryMapImpl") ProgrammerRepository repository, ProgrammerService service) {
    ...
    public ResponseEntity<Programmer> getProgrammerById(@PathVariable("id") Long programmerId){
        try {
            return ResponseEntity.ok(repository.findById(programmerId));
        } catch (Exception e){
